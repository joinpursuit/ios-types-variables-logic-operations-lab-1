...
```
// the answer is = they are all incorrect none compile 
***
...
let compareEquation = (sum + diff) == (a + a + b - b)

let compareEqutionNumTwo = (sum + diff) == (2 * a)
...
var humanYears = rockysAge / dogYears
